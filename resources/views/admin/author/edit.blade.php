	          ...
	          {{ method_field('PUT') }}
	            ...
	            <div class="col-lg-offset-3 col-lg-6">
	              <div class="form-group">
	                ...
	                <input type="text" class="form-control" id="name" name="name" placeholder="Category Title" value="{{ $author->name }}">
	              </div>
				  ...
				  <div class="form-group">
	                ...
	                <input type="color" class="form-control" id="color" name="color" placeholder="Color" style="width: 45px;" value="{{ $author->color }}">
	              </div>
					@if( $author->image)

  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <a class='col-lg-offset-5 btn btn-success' href="{{ route('authors.create') }}">Add New</a>
                        ...
                        @foreach ($authors as $author)
                          <tr>
                            ...
                            <td>@if( $author->image)
                              ...
                              @endif</td>
                              <td><a href="{{ route('authors.edit',$author->id) }}"><span class="glyphicon glyphicon-edit"></span></a></td>
                              <td>
